<section class="shortcode-testimonials shortcode-testimonials-style-1 section-testimonial-1 pb-120 position-relative">
                ...
                <div class="pe-8 mt-10">
                    @if($shortcode->subtitle)
                        <div class="d-flex align-items-center justify-content-center bg-primary-soft border border-2 border-white d-inline-flex rounded-pill px-4 py-2" data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <span class="tag-spacing fs-7 fw-bold text-linear-2 ms-2">{!! BaseHelper::clean($shortcode->subtitle) !!}</span>
                        </div>
                    @endif
                    @if($shortcode->title)
                    ...
                    @if($shortcode->description)
                        <span class="fs-5 fw-medium" data-aos="fade-zoom-in" data-aos-delay="300">
                    ...
                    @if($shortcode->primary_action_label || $shortcode->secondary_action_label)
                        <div class="d-flex flex-wrap align-items-center mt-8">
                            @if($shortcode->primary_action_label)
                                <a href="{{ $shortcode->primary_action_url }}" class="btn btn-outline-secondary hover-up" data-aos="fade-zoom-in" data-aos-delay="100">
                            ...
                            @if($shortcode->secondary_action_label)
                                <a href="{{ $shortcode->secondary_action_url }}" class="ms-5 ms-md-5 mt-5 mt-md-0 fw-bold" data-aos="fade-zoom-in" data-aos-delay="300">
