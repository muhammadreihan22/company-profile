<section class="shortcode-teams shortcode-teams-style-1 section-team-1 section-padding position-relative overflow-hidden">
    <div class="container">
        <div class="row position-relative z-1">
            <div class="text-center">
                ...
                @if($shortcode->description)
                    <p class="fs-5" data-aos="fade-zoom-in" data-aos-delay="300">
