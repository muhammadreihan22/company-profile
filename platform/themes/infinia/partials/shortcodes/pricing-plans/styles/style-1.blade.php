<section class="shortcode-pricing-plans shortcode-pricing-plans-style-1 section-pricing-1 position-relative pb-120 @@classList overflow-hidden">
    <div class="container">
        <div class="row pb-9 position-relative z-1">
            <div class="col-lg-auto me-lg-auto">
                <div class="text-start mb-lg-0 mb-5">
                    ...
                    @endif
                    @if($shortcode->title)
                        <h3 class="ds-3 my-3" data-aos="fade-zoom-in" data-aos-delay="200">{!! BaseHelper::clean($shortcode->title) !!}</h3>
                    @endif
                    @if($shortcode->description)
                        <p class="fs-5 mb-0" data-aos="fade-zoom-in" data-aos-delay="300">
