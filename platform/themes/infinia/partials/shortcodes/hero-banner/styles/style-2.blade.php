<section class="shortcode-hero-banner shortcode-hero-banner-style-2 section-hero-2 position-relative fix section-padding pb-lg-0">
    <div class="container">
        <div class="row text-center position-relative z-1">
            <div class="col">
                @if ($subtitle = $shortcode->subtitle)
                    <div class="border-linear-1 rounded-pill d-inline-block mb-2" data-aos="zoom-in" data-aos-delay="100">
                ...
                @if(($primaryButtonLabel && $primaryButtonUrl) || ($secondaryButtonUrl && $secondaryButtonLabel))
                    <div class="d-flex gap-3 flex-column flex-md-row justify-content-center">
                        ...
                        @if($secondaryButtonUrl && $secondaryButtonLabel)
                            <a href="{{ $secondaryButtonUrl }}" class="btn btn-outline-secondary hover-up" data-aos="fade-zoom-in" data-aos-delay="300">
