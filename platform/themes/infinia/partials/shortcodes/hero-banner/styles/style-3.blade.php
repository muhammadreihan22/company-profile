<section class="shortcode-hero-banner shortcode-hero-banner-style-3 section-hero-3 position-relative fix section-padding">
    <div class="container">
        <div class="row align-items-center position-relative">
            <div class="col-lg-7 position-relative z-1 mb-lg-0 pb-10 mb-">
                <div class="text-start mb-lg-0 mb-5">
                    ...
                    @if($primaryButtonLabel && $primaryButtonUrl)
                        <a href="{{ $primaryButtonUrl }}" class="btn btn-gradient" data-aos="fade-zoom-in" data-aos-delay="300">
                    ...
                    @if($secondaryButtonLabel && $secondaryButtonUrl)
                        <a href="{{ $secondaryButtonUrl }}" class="ms-md-3 btn btn-outline-secondary hover-up" data-aos="fade-zoom-in" data-aos-delay="500">
            ...
            <div class="col-lg-7 position-xl-absolute mb-lg-10 top-50 end-0 translate-middle-lg-y z-0">
                ...
                <div class="position-absolute top-50 start-50 translate-middle pb-10 pe-10">
                    <img class="rotateme" src="{{ Theme::asset()->url('images/shapes/star-rotate.png') }}" alt="star" />
                </div>
