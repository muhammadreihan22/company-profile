...
<section class="shortcode-faqs shortcode-faqs-style-3 section-faqs-1 section-padding position-relative">
                    ...
                    @if (($primaryButtonLabel && $primaryButtonUrl) || ($secondaryButtonLabel && $secondaryButtonUrl))
                        <div class="d-flex align-items-center mt-5">
                            ...
                            @if($secondaryButtonUrl && $secondaryButtonLabel)
                                <a href="{{ $secondaryButtonUrl }}" class="ms-5 fw-bold" data-aos="fade-zoom-in" data-aos-delay="500">
