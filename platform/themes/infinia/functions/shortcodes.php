...
app()->booted(function (): void {
    ...
    Shortcode::setAdminConfig('features', function (array $attributes) {
        return ShortcodeForm::createFromArray($attributes)
            ...
            ->addOpenFieldset('floating_card', [
                'data-bb-collapse' => 'true',
                'data-bb-trigger' => '[name=style]',
                'data-bb-value' => '[2, 5, 6, 8]',
                'style' => in_array($attributes['style'] ?? 1, [2, 5, 6, 8]) ? '' : 'display: none;',
            ])
            ->add(
                'floating_card_label',
                LabelField::class,
            ...
            ->add(
                ...
                MediaImageField::class,
                MediaImageFieldOption::make()
                    ->collapsible('style', [2, 5, 6], $attributes['style'] ?? 1)
                    ->label(__('Floating card image'))
            )
            ->add(
                'floating_card_title',
                TextField::class,
                TextFieldOption::make()
                    ->collapsible('style', [2, 5, 6, 8], $attributes['style'] ?? 1)
                    ->label(__('Floating card title'))
            )
            ->add(
    ...
    Shortcode::register('feature-tabs', __('Feature Tabs'), __('Feature Tabs'), function (ShortcodeCompiler $shortcode) {
        $tabs = Shortcode::fields()->getTabsData([
            ...
            'description',
            'image',
            'feature_item_title_1',
            'feature_item_description_1',
            'feature_item_icon_1',
            'feature_item_icon_image_1',
            'feature_item_title_2',
            'feature_item_description_2',
            'feature_item_icon_2',
            'feature_item_icon_image_2',
        ], $shortcode);
            ...
            ->add(
                ...
                ShortcodeTabsFieldOption::make()
                    ...
                    ->fields([
                        ...
                        'feature_item_title_1' => [
                            'title' => __('Feature title :number', ['number' => 1]),
                        ],
                        'feature_item_description_1' => [
                            'title' => __('Feature title :number', ['number' => 1]),
                            'type' => 'textarea',
                        ...
                        'feature_item_icon_1' => [
                            'title' => __('Feature icon :number', ['number' => 1]),
                            'type' => 'coreIcon',
                        ],
                        'feature_item_icon_image_1' => [
                            'title' => __('Feature icon image :number (It will override icon above if set)', ['number' => 1]),
                            'type' => 'image',
                        ],
                        'feature_item_title_2' => [
                            'title' => __('Feature title :number', ['number' => 2]),
                        ],
                        'feature_item_description_2' => [
                            'title' => __('Feature title :number', ['number' => 2]),
                            'type' => 'textarea',
                        ...
                        'feature_item_icon_2' => [
                            'title' => __('Feature icon :number', ['number' => 2]),
                            'type' => 'coreIcon',
                        ],
                        'feature_item_icon_image_2' => [
                            'title' => __('Feature icon image :number (It will override icon above if set)', ['number' => 2]),
                            'type' => 'image',
                        ],
                    ])
            )
